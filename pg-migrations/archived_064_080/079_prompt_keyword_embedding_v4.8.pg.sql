-- Migration: 079_prompt_keyword_embedding_v4.8.pg.sql (PostgreSQL版本)
...
**规则2: 嵌入方式 (自然融入，非堆砌)**
- ✅ 正确: "4K Security Camera Sale" (关键security camera)
...
**社会证明类 (Social Proof)**:
- "10000+ Sold", "Best Seller", "Top Rated", "Awarning"
