-- Migration: Rebuild creative_versions table with correct schema (PostgreSQL)
-- Date: 2025-12-03
...
DO $$
BEGIN
  IF EXISTS (SELECT 1 FROM information_schema.tables WHERE table_name = 'creative_versions') THEN
