...
This project is indexed by GitNexus as **autobb** (35112 symbols, 64481 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
