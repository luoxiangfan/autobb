...
This project is indexed by GitNexus as **autobb** (35011 symbols, 64222 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
