...
This project is indexed by GitNexus as **autobb** (34585 symbols, 63098 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
