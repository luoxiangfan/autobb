...
**检查时间**: 2026-04-04 20:30 (Asia/Shanghai)  
...
| 补丁类型 | 文件路径 | 大小 | 状态 |
|----------|----------|------|------|
| 暂存区变更 (最新) | `patches/google-ads-staged-changes-2026-04-04-2030.patch` | 5695 行 | 已生成 |
...
git apply patches/google-ads-staged-changes-2026-04-04-2030.patch

# 方法 2: 使用 patch 命令
patch -p1 < patches/google-ads-staged-changes-2026-04-04-2030.patch
```
...
*报告由 cron 任务自动生成*  
*下次检查时间：2026-04-04 21:30 (Asia/Shanghai)*
