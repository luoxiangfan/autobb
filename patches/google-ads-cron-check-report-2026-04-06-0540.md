...
**检查时间**: 2026-04-06 05:40 (Asia/Shanghai)  
...
当前暂存区包含 **25 个文件** 的变更，其中 **5 个核心源文件** 与 Google Ads API 集成直接相关。
...
| 补丁文件 | 说明 | 适用场景 |
|----------|------|----------|
| `google-ads-api-integration-patch-2026-04-06-0338.patch` | 5 个核心文件的变更 | 仅应用 Google Ads API 变更 |
| `google-ads-staged-changes-2026-04-06-0338.patch` | 暂存区所有变更 | 应用完整暂存区内容 |
| `google-ads-head-commit-changes-2026-04-06-0338.patch` | HEAD 提交差异 | 查看提交间差异 |
...
**建议操作**: 提交暂存区变更以完成 Google Ads 共享授权配置系统的核心功能。

---

**报告生成**: cron:a442a652-b2d0-4380-93dc-c97844f6ab32  
**补丁位置**: `/home/admin/openclaw/workspace/autobb/patches/`
