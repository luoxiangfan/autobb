...
**检查时间**: 2026-04-06 10:44 (Asia/Shanghai)  
...
当前暂存区包含 **5 个核心源文件** 的变更，均与 Google Ads API 集成直接相关。
...
| 补丁文件 | 说明 |
|----------|------|
| `patches/google-ads-staged-changes-2026-04-06-1044.patch` | 当前暂存区完整变更 (5 个文件) |

### 历史补丁文件（供参考）

| 补丁文件 | 说明 |
|----------|------|
| `patches/google-ads-staged-changes-2026-04-06-0540.patch` | 05:40 检查时的暂存区变更 |
| `patches/google-ads-staged-changes-2026-04-06-0338.patch` | 03:38 检查时的暂存区变更 |
| `patches/google-ads-api-integration-patch-2026-04-06-0338.patch` | Google Ads API 核心变更 |
...
# 应用暂存区变更
git apply patches/google-ads-staged-changes-2026-04-06-1044.patch
...
| 分支 | 状态 | 说明 |
|------|------|------|
| 本地 feature/google-ads-shared-auth | 有暂存变更 | 领先远程 |
| origin/main | 同步 | 最新提交 79fbeb7 |
| origin/feature/google-ads-shared-auth | 不存在 | 本地分支未推送 |
...
3. **补丁已生成**，路径：`patches/google-ads-staged-changes-2026-04-06-1044.patch`
...
**补丁位置**: `/home/admin/openclaw/workspace/autobb/patches/google-ads-staged-changes-2026-04-06-1044.patch`  
**状态**: ✅ 检查完成
