...
**检查时间**: 2026-04-06 19:55 (Asia/Shanghai)  
...
| 补丁文件 | 路径 |
|----------|------|
| `google-ads-staged-changes-2026-04-06-1955.patch` | `/home/admin/openclaw/workspace/autobb/patches/` |
...
# 应用补丁
git apply patches/google-ads-staged-changes-2026-04-06-1955.patch
...
3. **补丁已生成**，路径：`/home/admin/openclaw/workspace/autobb/patches/google-ads-staged-changes-2026-04-06-1955.patch`
...
**补丁位置**: `/home/admin/openclaw/workspace/autobb/patches/google-ads-staged-changes-2026-04-06-1955.patch`  
**状态**: ✅ 检查完成
