...
**检查时间**: 2026-04-07 03:03 (Asia/Shanghai)  
...
| HEAD 提交 | `577c06d` (2026-04-02) |
| 暂存文件 | 25 个 (5 个源文件 + 20 个补丁/报告文件) |
| 未暂存文件 | 40+ 个补丁和报告文件 |
...
| 补丁文件 | 路径 | 大小 |
|----------|------|------|
| `google-ads-api-changes-2026-04-07-0303.patch` | `/home/admin/openclaw/workspace/autobb/patches/` | 125 行 |
| `google-ads-staged-changes-2026-04-07-0202.patch` | `/home/admin/openclaw/workspace/autobb/patches/` | 完整暂存区 |
...
# 应用核心 API 变更补丁
git apply patches/google-ads-api-changes-2026-04-07-0303.patch
...
3. **补丁已生成**，路径：`/home/admin/openclaw/workspace/autobb/patches/google-ads-api-changes-2026-04-07-0303.patch`
...
**补丁位置**: `/home/admin/openclaw/workspace/autobb/patches/google-ads-api-changes-2026-04-07-0303.patch`  
**状态**: ✅ 检查完成
