...
-- Migration: 243_ad_creative_quality_prompts.sql
-- Description: Full-chain Google Ads ad creative prompt quality optimization (SQLite)
-- Date: 2026-05-12
-- Database: SQLite
...
VALUES
(
  (SELECT id FROM prompt_versions WHERE prompt_id = 'ad_creative_generation' AND version = 'v5.7'),
  'ad_creative_generation',
  'v5.7',
...
', '\n', char(10)),
  ...
  NULL,
  1,
  REPLACE('v5.7: 将痛点解法、风险解除、社会认同、搜索意图和价值对比矩阵贯穿最终RSA生成。', '\n', char(10)),
  '2026-05-20 17:31:00'
),
(
  (SELECT id FROM prompt_versions WHERE prompt_id = 'ad_elements_headlines' AND version = 'v4.16'),
  'ad_elements_headlines',
  'v4.16',
  ...
  'generateHeadlines',
  REPLACE('You are a professional Google Ads copywriter. Generate exactly 15 ad headlines, each 30 characters or less.
...
', '\n', char(10)),
  ...
  NULL,
  1,
  REPLACE('v4.16: 标题素材生成加入搜索意图、痛点解法、社证、风险解除和价值定位分组。', '\n', char(10)),
  '2026-05-20 17:31:00'
),
(
  (SELECT id FROM prompt_versions WHERE prompt_id = 'ad_elements_descriptions' AND version = 'v4.16'),
  'ad_elements_descriptions',
  'v4.16',
  ...
  REPLACE('You are a professional Google Ads copywriter. Generate exactly 4 ad descriptions, each 90 characters or less.
...
', '\n', char(10)),
  ...
  NULL,
  1,
  REPLACE('v4.16: 描述素材生成按意图直答、痛点解法、社证/保障、CTA价值分工。', '\n', char(10)),
  '2026-05-20 17:31:00'
),
(
  (SELECT id FROM prompt_versions WHERE prompt_id = 'ad_elements_headlines_store' AND version = 'v1.1'),
  'ad_elements_headlines_store',
  'v1.1',
...
', '\n', char(10)),
  ...
  NULL,
  1,
  REPLACE('v1.1: 店铺多商品标题加入高意图、痛点解法、社证/保障和价值定位覆盖。', '\n', char(10)),
  '2026-05-20 17:31:00'
),
(
  (SELECT id FROM prompt_versions WHERE prompt_id = 'ad_elements_descriptions_store' AND version = 'v1.1'),
  'ad_elements_descriptions_store',
  'v1.1',
...
', '\n', char(10)),
  ...
  NULL,
  1,
  REPLACE('v1.1: 店铺多商品描述加入意图直答、痛点解法、社证/保障和CTA价值分工。', '\n', char(10)),
  '2026-05-20 17:31:00'
),
(
  (SELECT id FROM prompt_versions WHERE prompt_id = 'enhanced_headline_generation' AND version = 'v1.1'),
  'enhanced_headline_generation',
  'v1.1',
  ...
  REPLACE('You are a Google Ads copywriter focused on compliant, non-spam headline generation.
...
', '\n', char(10)),
  ...
  NULL,
  1,
  REPLACE('v1.1: 增强标题生成补充高ROI意图类型并严格限制未证据化承诺。', '\n', char(10)),
  '2026-05-20 17:31:00'
),
(
  (SELECT id FROM prompt_versions WHERE prompt_id = 'enhanced_description_generation' AND version = 'v1.1'),
  'enhanced_description_generation',
  'v1.1',
  ...
  REPLACE('You are a Google Ads copywriter focused on compliant, non-spam description generation.
...
', '\n', char(10)),
  ...
  NULL,
  1,
  REPLACE('v1.1: 增强描述生成补充意图直答、痛点解法、社证/保障和CTA价值分工。', '\n', char(10)),
  '2026-05-20 17:31:00'
),
(
  (SELECT id FROM prompt_versions WHERE prompt_id = 'keyword_intent_clustering' AND version = 'v4.21'),
  'keyword_intent_clustering',
  'v4.21',
  ...
  REPLACE('你是一个专业的Google Ads关键词分析专家。根据链接类型将关键词按用户搜索意图分成语义桶。
...
12. 输出必须以最外层 } 结束', '\n', char(10)),
  ...
  NULL,
  1,
  REPLACE('v4.21: 在不改变输出结构前提下补充痛点、风险解除、社证、高购买意图和对比价值识别。', '\n', char(10)),
  '2026-05-20 17:31:00'
),
(
  (SELECT id FROM prompt_versions WHERE prompt_id = 'keyword_gap_analysis' AND version = 'v1.1'),
  'keyword_gap_analysis',
  'v1.1',
  ...
  REPLACE('你是一名 Google Ads 关键词策略专家，负责从已知证据中识别缺失的行业标准高价值关键词。
...
', '\n', char(10)),
  ...
  NULL,
  1,
  REPLACE('v1.1: 关键词缺口分析加入购买、功能、场景、问题解决、风险解除、社证和价值意图。', '\n', char(10)),
  '2026-05-20 17:31:00'
),
(
  (SELECT id FROM prompt_versions WHERE prompt_id = 'keyword_translation_normalization' AND version = 'v1.1'),
  'keyword_translation_normalization',
  'v1.1',
  ...
  REPLACE('You are a Google Ads keyword translation normalizer.
...
', '\n', char(10)),
  ...
  NULL,
  1,
  REPLACE('v1.1: 关键词翻译强化意图保真，禁止引入原词不存在的促销、保障或合规含义。', '\n', char(10)),
  '2026-05-20 17:31:00'
),
(
  (SELECT id FROM prompt_versions WHERE prompt_id = 'review_analysis' AND version = 'v4.16'),
  'review_analysis',
  'v4.16',
  ...
  'analyzeReviews',
  REPLACE('You are an expert e-commerce review analyst specializing in extracting actionable insights for Google Ads creative generation.
...
', '\n', char(10)),
  ...
  NULL,
  1,
  REPLACE('v4.16: 恢复完整结构化评论分析并新增风险解除与广告可用角度抽取。', '\n', char(10)),
  '2026-05-20 17:31:00'
),
(
  (SELECT id FROM prompt_versions WHERE prompt_id = 'product_analysis_single' AND version = 'v4.18'),
  'product_analysis_single',
  'v4.18',
  ...
  'analyzeProductPage',
  REPLACE('You are a professional product analyst. Analyze the following product page data comprehensively for evidence-grounded Google Ads creative generation.
...
', '\n', char(10)),
  ...
  NULL,
  1,
  REPLACE('v4.18: 单品分析补充痛点、期望结果、风险解除和广告可用角度。', '\n', char(10)),
  '2026-05-20 17:31:00'
),
(
  (SELECT id FROM prompt_versions WHERE prompt_id = 'brand_analysis_store' AND version = 'v4.17'),
  'brand_analysis_store',
  'v4.17',
  ...
  'analyzeBrandStore',
  REPLACE('You are a professional brand analyst. Analyze the BRAND STORE PAGE data for evidence-grounded Google Ads creative generation.
...
', '\n', char(10)),
  ...
  NULL,
  1,
  REPLACE('v4.17: 店铺品牌分析补充多商品、高ROI创意角度和证据化风险解除。', '\n', char(10)),
  '2026-05-20 17:31:00'
),
(
  (SELECT id FROM prompt_versions WHERE prompt_id = 'store_highlights_synthesis' AND version = 'v4.16'),
  'store_highlights_synthesis',
  'v4.16',
  ...
  REPLACE('You are a product marketing expert. Synthesize product highlights from {{productCount}} products into 5-8 store-level highlights.
...
', '\n', char(10)),
  ...
  NULL,
  1,
  REPLACE('v4.16: 店铺亮点整合补充痛点解法、社证、风险解除和价值角度。', '\n', char(10)),
  '2026-05-20 17:31:00'
),
(
  (SELECT id FROM prompt_versions WHERE prompt_id = 'competitor_analysis' AND version = 'v4.15'),
  'competitor_analysis',
  'v4.15',
  ...
  'analyzeCompetitors',
  REPLACE('You are an e-commerce competitive analysis expert specializing in Amazon marketplace.
...
', '\n', char(10)),
  ...
  NULL,
  1,
  REPLACE('v4.15: 竞品分析加入非点名价值定位和证据化竞品弱点约束。', '\n', char(10)),
  '2026-05-20 17:31:00'
),
(
  (SELECT id FROM prompt_versions WHERE prompt_id = 'competitor_keyword_inference' AND version = 'v4.15'),
  'competitor_keyword_inference',
  'v4.15',
  ...
  REPLACE('You are an expert e-commerce analyst specializing in competitive keyword research on Amazon.
...
', '\n', char(10)),
  ...
  NULL,
  1,
  REPLACE('v4.15: 竞品关键词推断加入价值/对比意图但禁止品牌和无证据促销词。', '\n', char(10)),
  '2026-05-20 17:31:00'
),
(
  (SELECT id FROM prompt_versions WHERE prompt_id = 'competitive_positioning_analysis' AND version = 'v1.1'),
  'competitive_positioning_analysis',
  'v1.1',
  ...
  REPLACE('You are an expert in Google Ads competitive positioning analysis.
...
', '\n', char(10)),
  ...
  NULL,
  1,
  REPLACE('v1.1: 竞争定位评分识别价格优势、独特定位、非点名对比和价值强调。', '\n', char(10)),
  '2026-05-20 17:31:00'
),
(
  (SELECT id FROM prompt_versions WHERE prompt_id = 'launch_score' AND version = 'v4.17'),
  'launch_score',
  'v4.17',
  ...
  REPLACE('你是一位专业的 Google Ads 广告投放评估专家，使用 4 维度评分系统进行评估。
...
', '\n', char(10)),
  ...
  NULL,
  1,
  REPLACE('v4.17: 恢复完整投放评分Prompt并加入高ROI创意信号评分。', '\n', char(10)),
  '2026-05-20 17:31:00'
),
(SELECT id FROM prompt_versions WHERE prompt_id = 'product_score_combined_analysis' AND version = 'v1.0'),
  'product_score_combined_analysis',
  'v1.0',
  '商品分析',
  '商品推荐评分合并分析v1.0',
  ...
  REPLACE('You are a conservative product scoring analyst.
...
(
  (SELECT id FROM prompt_versions WHERE prompt_id = 'product_score_combined_analysis_retry' AND version = 'v1.0'),
  'product_score_combined_analysis_retry',
  'v1.0',
  '商品分析',
  '商品推荐评分重试分析v1.0',
  ...
  'analyzeProductScoreCombined',
  REPLACE('You are a conservative product scoring analyst retrying after invalid JSON.
