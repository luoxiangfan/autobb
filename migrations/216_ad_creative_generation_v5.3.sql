-- Migration: 216_ad_creative_generation_v5.3.sql
...
SELECT
  (SELECT id FROM prompt_versions WHERE prompt_id = 'ad_creative_generation' AND version = 'v5.3'),
...
- 若未提供安全的 retained keyword plan，则回退到高质量自然 headline，不强制硬塞关键词'
  ...
  base.created_by,
  1,
  REPLACE('v5.3 - Protected Top Headlines + Diverse Retained Slots:
