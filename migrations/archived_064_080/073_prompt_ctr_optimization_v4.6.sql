-- =====================================================
-- Migration: 073_prompt_ctr_optimization_v4.6.sql
-- Date: 2025-12-12
-- Purpose: CTR/CPC优化 - 全面增强标题、描述和核心创意生成
-- 整合内容:
--   1. ad_elements_headlines v3.2 → v3.3 (从073迁移)
--   2. ad_elements_descriptions v3.2 → v3.3 (从073迁移)
--   3. ad_creative_generation v4.5 → v4.6 (从074迁移)
-- Changes:
--   Headlines v3.3:
--     - DKI模板支持
--     - 数字具体化策略
