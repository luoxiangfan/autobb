-- Migration: 069_integrated_prompt_v4.4_complete.sql
-- Description: 数据库字段扩展 + Prompt v4.4完整集成版
-- Date: 2025-12-10
--
-- 整合内容:
...
-- 禁用旧版本（v4.2及以下）
UPDATE prompt_versions SET is_active = 0 WHERE prompt_id = 'ad_creative_generation' AND version != 'v4.4';
...
-- 确保v4.4为活跃版本
UPDATE prompt_versions SET is_active = 1 WHERE prompt_id = 'ad_creative_generation' AND version = 'v4.4';
