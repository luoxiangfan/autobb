...
export default function UrlSwapHistory({ open, onOpenChange, taskId }: UrlSwapHistoryProps) {
                      ...
                      <div className="grid grid-cols-2 gap-4 mb-3">
                        {entry.previous_final_url && (
                          <div className="bg-red-100/50 rounded p-2">
                            ...
                            {buildUrlWithSuffix(
                              entry.previous_final_url,
                              entry.previous_final_url_suffix
                            ) ? (
                              <a
                                href={buildUrlWithSuffix(
                                  entry.previous_final_url,
                                  entry.previous_final_url_suffix
                                )}
                                target="_blank"
