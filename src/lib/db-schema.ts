...
export const DEFAULT_SETTINGS = [
  ...
  { category: 'google_ads', key: 'developer_token', dataType: 'string', isSensitive: true, isRequired: true, description: 'Google Ads Developer Token' },
  {
    ...
    isSensitive: false,
    isRequired: false,
    defaultValue: 'dedicated_user',
    description: 'Google Ads 应用凭证来源：dedicated_user=用户自备；inherit_org=使用管理员组织级配置',
  },
  {
    category: 'google_ads_shared',
    key: 'client_id',
    dataType: 'string',
    isSensitive: true,
    isRequired: true,
    description: '组织级 Google Ads OAuth Client ID（供 inherit_org 用户使用）',
  },
  {
    category: 'google_ads_shared',
    key: 'client_secret',
    ...
    isSensitive: true,
    isRequired: true,
    description: '组织级 Google Ads OAuth Client Secret',
  },
  {
    category: 'google_ads_shared',
    key: 'developer_token',
    ...
    isSensitive: true,
    isRequired: true,
    description: '组织级 Google Ads Developer Token',
  },
