...
export const TABLES: TableDef[] = [
...

  {
    ...
    columns: [
      ...
      { name: 'launch_viability_score', type: 'INTEGER', notNull: true, default: '0' },
      { name: 'ad_quality_score', type: 'INTEGER', notNull: true, default: '0' },
      { name: 'keyword_strategy_score', type: 'INTEGER', notNull: true, default: '0' },
      { name: 'basic_config_score', type: 'INTEGER', notNull: true, default: '0' },
      { name: 'launch_viability_data', type: 'JSON' },
      { name: 'ad_quality_data', type: 'JSON' },
      { name: 'keyword_strategy_data', type: 'JSON' },
      { name: 'basic_config_data', type: 'JSON' },
      ...
      { name: 'issues', type: 'TEXT' },
      { name: 'suggestions', type: 'TEXT' },
      { name: 'content_hash', type: 'TEXT' },
      { name: 'campaign_config_hash', type: 'TEXT' },
    ],
  },
