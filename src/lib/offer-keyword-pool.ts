...
function getKeywordSourcePriorityForPoolItem(
...
function hasCommercialIntentForProductRelaxedRetention(keyword: string, language: string): boolean {
  if (!keyword) return false
