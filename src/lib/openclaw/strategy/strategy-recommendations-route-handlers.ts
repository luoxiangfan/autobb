...
export type StrategyRecommendationsRequestUser = {
  userId: number
}

export type StrategyRecommendationsRouteConfig = {
  resolveRequestUser: (request: NextRequest) => Promise<StrategyRecommendationsRequestUser | null>
...
export function createStrategyRecommendationsRouteHandlers(config: StrategyRecommendationsRouteConfig) {
