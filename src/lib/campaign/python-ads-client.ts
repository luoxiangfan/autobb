...
async function withTracking<T>(
  ...
  try {
    ...
    if (error?.isAxiosError) {
      ...
      const serviceDetail =
        stringifyDetail(error?.response?.data?.detail) || error?.message || String(error)
      const safeMessage =
...
export async function getKeywordHistoricalMetricsPython(params: {
  ...
  return withTracking(
    params.userId,
    params.customerId,
    ApiOperationType.GET_KEYWORD_IDEAS,
    ...
    async () => {
      ...
      const response = await axios.post(
        `${PYTHON_SERVICE_URL}/api/keyword-planner/historical-metrics`,
        {
...
export async function getKeywordIdeasPython(params: {
  ...
  return withTracking(
    ...
    async () => {
      const serviceAccount = await getServiceAccountAuth(params.userId, params.serviceAccountId)
      const response = await axios.post(
        `${PYTHON_SERVICE_URL}/api/keyword-planner/ideas`,
        {
          service_account: withUserIdInServiceAccount(serviceAccount, params.userId),
          customer_id: params.customerId,
          keywords: params.keywords,
...
export async function executeGAQLQueryPython(params: {
  ...
  return withTracking(
    ...
    async () => {
      const serviceAccount = await getServiceAccountAuth(params.userId, params.serviceAccountId)
      const response = await axios.post(
        `${PYTHON_SERVICE_URL}/api/google-ads/query`,
        {
          service_account: withUserIdInServiceAccount(serviceAccount, params.userId),
          customer_id: params.customerId,
          query: params.query,
...
export async function listAccessibleCustomersPython(params: {
  ...
  const response = await axios.post(
    `${PYTHON_SERVICE_URL}/api/google-ads/list-accessible-customers`,
    {
      service_account: withUserIdInServiceAccount(serviceAccount, params.userId),
    },
    {
...
export async function getIdentityVerificationPython(params: {
  ...
  return withTracking(
    ...
    async () => {
      const serviceAccount = await getServiceAccountAuth(params.userId, params.serviceAccountId)
      const response = await axios.post(
        `${PYTHON_SERVICE_URL}/api/google-ads/identity-verification`,
        {
          service_account: withUserIdInServiceAccount(serviceAccount, params.userId),
          customer_id: params.customerId,
        },
...
export async function createCampaignBudgetPython(params: {
  ...
  return withTracking(
    ...
    async () => {
      const serviceAccount = await getServiceAccountAuth(params.userId, params.serviceAccountId)
      const response = await axios.post(
        `${PYTHON_SERVICE_URL}/api/google-ads/campaign-budget/create`,
        {
          service_account: withUserIdInServiceAccount(serviceAccount, params.userId),
          customer_id: params.customerId,
          name: params.name,
...
export async function createCampaignPython(params: {
  ...
  return withTracking(
    ...
    async () => {
      const serviceAccount = await getServiceAccountAuth(params.userId, params.serviceAccountId)
      const response = await axios.post(
        `${PYTHON_SERVICE_URL}/api/google-ads/campaign/create`,
        {
          service_account: withUserIdInServiceAccount(serviceAccount, params.userId),
          customer_id: params.customerId,
          name: params.name,
...
export async function createAdGroupPython(params: {
  ...
  return withTracking(
    ...
    async () => {
      const serviceAccount = await getServiceAccountAuth(params.userId, params.serviceAccountId)
      const response = await axios.post(
        `${PYTHON_SERVICE_URL}/api/google-ads/ad-group/create`,
        {
          service_account: withUserIdInServiceAccount(serviceAccount, params.userId),
          customer_id: params.customerId,
...
export async function createKeywordsPython(params: {
  ...
  return withTracking(
    ...
    async () => {
      const serviceAccount = await getServiceAccountAuth(params.userId, params.serviceAccountId)
      const response = await axios.post(
        `${PYTHON_SERVICE_URL}/api/google-ads/keywords/create`,
        {
          service_account: withUserIdInServiceAccount(serviceAccount, params.userId),
          customer_id: params.customerId,
...
export async function createResponsiveSearchAdPython(params: {
  ...
  return withTracking(
    ...
    async () => {
      const serviceAccount = await getServiceAccountAuth(params.userId, params.serviceAccountId)
      const response = await axios.post(
        `${PYTHON_SERVICE_URL}/api/google-ads/responsive-search-ad/create`,
        {
          service_account: withUserIdInServiceAccount(serviceAccount, params.userId),
          customer_id: params.customerId,
          ad_group_resource_name: params.adGroupResourceName,
...
export async function updateCampaignStatusPython(params: {
  ...
  return withTracking(
    ...
    async () => {
      const serviceAccount = await getServiceAccountAuth(params.userId, params.serviceAccountId)
      await axios.post(
        `${PYTHON_SERVICE_URL}/api/google-ads/campaign/update-status`,
        {
          service_account: withUserIdInServiceAccount(serviceAccount, params.userId),
          customer_id: params.customerId,
          campaign_resource_name: params.campaignResourceName,
...
export async function removeCampaignPython(params: {
  ...
  return withTracking(
    ...
    async () => {
      const serviceAccount = await getServiceAccountAuth(params.userId, params.serviceAccountId)
      await axios.post(
        `${PYTHON_SERVICE_URL}/api/google-ads/campaign/remove`,
        {
          service_account: withUserIdInServiceAccount(serviceAccount, params.userId),
          customer_id: params.customerId,
          campaign_resource_name: params.campaignResourceName,
...
export async function updateCampaignBudgetPython(params: {
  ...
  return withTracking(
    ...
    async () => {
      const serviceAccount = await getServiceAccountAuth(params.userId, params.serviceAccountId)
      await axios.post(
        `${PYTHON_SERVICE_URL}/api/google-ads/campaign/update-budget`,
        {
          service_account: withUserIdInServiceAccount(serviceAccount, params.userId),
          customer_id: params.customerId,
          campaign_resource_name: params.campaignResourceName,
...
export async function updateCampaignFinalUrlSuffixPython(params: {
  ...
  return withTracking(
    ...
    params.customerId,
    ApiOperationType.MUTATE,
    '/api/google-ads/campaign/update-final-url-suffix',
    params.requestId,
    async () => {
      const serviceAccount = await getServiceAccountAuth(params.userId, params.serviceAccountId)
      await axios.post(
        `${PYTHON_SERVICE_URL}/api/google-ads/campaign/update-final-url-suffix`,
        {
          service_account: withUserIdInServiceAccount(serviceAccount, params.userId),
          customer_id: params.customerId,
          campaign_resource_name: params.campaignResourceName,
...
export async function createCalloutExtensionsPython(params: {
  ...
  return withTracking(
    ...
    async () => {
      const serviceAccount = await getServiceAccountAuth(params.userId, params.serviceAccountId)
      const response = await axios.post(
        `${PYTHON_SERVICE_URL}/api/google-ads/callout-extensions/create`,
        {
          service_account: withUserIdInServiceAccount(serviceAccount, params.userId),
          customer_id: params.customerId,
          campaign_resource_name: params.campaignResourceName,
...
export async function createSitelinkExtensionsPython(params: {
  ...
  return withTracking(
    ...
    async () => {
      const serviceAccount = await getServiceAccountAuth(params.userId, params.serviceAccountId)
      const response = await axios.post(
        `${PYTHON_SERVICE_URL}/api/google-ads/sitelink-extensions/create`,
        {
          service_account: withUserIdInServiceAccount(serviceAccount, params.userId),
          customer_id: params.customerId,
          campaign_resource_name: params.campaignResourceName,
...
export async function updateCampaignPython(params: {
  ...
  return withTracking(
    ...
    async () => {
      const serviceAccount = await getServiceAccountAuth(params.userId, params.serviceAccountId)
      await axios.post(
        `${PYTHON_SERVICE_URL}/api/google-ads/campaign/update`,
        {
          service_account: withUserIdInServiceAccount(serviceAccount, params.userId),
          customer_id: params.customerId,
          campaign_resource_name: params.campaignResourceName,
...
export async function updateAdGroupPython(params: {
  ...
  return withTracking(
    ...
    async () => {
      const serviceAccount = await getServiceAccountAuth(params.userId, params.serviceAccountId)
      await axios.post(
        `${PYTHON_SERVICE_URL}/api/google-ads/adgroup/update`,
        {
          service_account: withUserIdInServiceAccount(serviceAccount, params.userId),
          customer_id: params.customerId,
          ad_group_resource_name: params.adGroupResourceName,
