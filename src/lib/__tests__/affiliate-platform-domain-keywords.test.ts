...
describe('affiliate-platform-domain-keywords', () => {
  it('affiliateLinkMatchesPlatform uses domain keywords', () => {
    expect(affiliateLinkMatchesPlatform('https://yeahpromos.com/offer', 'YeahPromos')).toBe(true)
    expect(affiliateLinkMatchesPlatform('https://yeahpromos.com/offer', 'PartnerBoost')).toBe(false)
  })
