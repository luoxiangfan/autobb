    ...
    const keywords = await getCoverageBucketKeywords(
      {
        ...
        storeBucketAKeywords: [
          {
            keyword: 'acme robot vacuum collection',
            searchVolume: 400,
            source: 'KEYWORD_POOL',
            matchType: 'PHRASE',
          },
        ...
        storeBucketBKeywords: [
          {
            keyword: 'acme pet hair cleaning',
            searchVolume: 350,
            source: 'KEYWORD_POOL',
            matchType: 'PHRASE',
          },
        ...
        storeBucketDKeywords: [
          {
            keyword: 'acme authorized service',
            searchVolume: 250,
            source: 'KEYWORD_POOL',
            matchType: 'PHRASE',
          },
