...
const MODEL_INTENT_TRANSACTIONAL_PATTERN =
  /\b(buy|shop|purchase|order|discount|sale|deal|coupon|promo|offer|price|cost|cheap)\b/i
const MODEL_INTENT_SOFT_FAMILY_ALLOWED_EXTRA_TOKENS = new Set(['size'])
...
const CREATIVE_CONTEXT_FORBIDDEN_REASON_PATTERN =
...
const INTENT_TIGHTENING_RELAXABLE_HIGH_PRIORITY_HARD_BLOCK_REASONS =
...
function resolveCreativeContextMaxWordCount(
...
function extractStoreSignalsForKeywordQualityContext(
