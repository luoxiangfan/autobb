          ...
          <div className="text-center py-12 bg-white rounded-lg shadow-sm border border-gray-200">
            ...
            {tasks.length === 0 && (
              <div className="mt-6 flex justify-center">
                <Button onClick={() => router.push('/offers')} className="flex items-center gap-2">
              ...
              <Table className="[&_thead_th]:bg-white">
                <TableHeader>
                  <TableRow>
                    ...
                    <SortableHeader field="offer" className="w-[80px]">
                      Offer
                    </SortableHeader>
                    <SortableHeader field="status" className="w-[100px]">
                      状态
                    </SortableHeader>
                    <SortableHeader field="interval" className="w-[100px]">
                      间隔(分钟)
                    </SortableHeader>
                    <SortableHeader field="nextRun" className="w-[120px]">
                      下次执行
                    </SortableHeader>
                    <SortableHeader field="successRate" className="w-[100px]">
                      成功/总计
                    </SortableHeader>
