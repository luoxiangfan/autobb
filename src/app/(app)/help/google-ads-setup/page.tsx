          ...
          <TabsContent value="oauth" className="space-y-4 mt-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  通过用户授权访问 Google Ads 账号。Keyword Planner API 需要 Developer Token 具有
                  Basic 或 Standard 访问权限。
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  <div className="flex items-start gap-3">
                    <div className="shrink-0 w-8 h-8 bg-slate-200 rounded-full flex items-center justify-center text-sm font-semibold">
                      0
                    </div>
                    <div className="flex-1">
                      <h4 className="font-medium">建议先使用测试权限（Test Access）进行功能测试</h4>
                      <p className="text-sm text-gray-600 mt-1">
                        在向 Google 申请<strong>基本访问权限（Basic Access）</strong>
                        之前，建议先使用"测试权限（Test Access）"的 Developer Token 完成 OAuth
                        配置并测试产品功能。这样既能验证配置无误，也能通过真实调用记录提高后续审批通过率。
                      </p>
                      <div className="text-sm text-gray-600 mt-2 space-y-2">
                        ...
                        <p className="text-xs text-gray-500 mt-2">
                          <strong>提示：</strong>
                          使用测试权限时，只能访问测试账号。完成配置验证和功能测试后，可以同时向
                          Google 申请 Basic/Standard 权限，无需等待审批结果。
                        </p>
                        <p className="text-xs text-amber-600 mt-2">
                          <strong>注意：</strong>Test Access 和 Explorer Access 权限无法使用 Keyword
                          Planner API 获取搜索量数据，需要申请 Basic Access 或 Standard Access
                          才能使用该功能。
                        </p>
                      </div>
                    </div>
                  ...
                  <div className="flex items-start gap-3">
                    <div className="shrink-0 w-8 h-8 bg-blue-100 rounded-full flex items-center justify-center text-sm font-semibold">
                      1
                    </div>
                    <div>
                      ...
                      <p className="text-sm text-gray-600 mt-1">
                        ...
                        创建项目，然后在"API和服务"→"库"中搜索并启用 <strong>Google Ads API</strong>
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <h4 className="font-medium">
                        配置 OAuth 同意屏幕（目标对象：测试版 + OAuth 用户）
                      </h4>
                      <div className="text-sm text-gray-600 mt-1 space-y-2">
                        <p>
                          进入 Cloud Console 的 <strong>API和服务</strong>→
                          <strong>OAuth权限请求</strong>页面，在"目标对象"中确认"发布状态"为
                          <strong>测试版</strong>，"用户类型"为<strong>外部</strong>。
                        </p>
                        <p className="text-red-600">
                          并将<strong>MCC 所属的 Gmail 邮箱</strong>加入到"OAuth
                          用户列表/测试用户"中，否则授权时可能无法通过。
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      <h4 className="font-medium" id="oauth-client-id">
                        创建 OAuth 客户端
                      </h4>
                      <p className="text-sm text-gray-600 mt-1">
                        进入
                        ...
                        页面，点击"创建凭据"→"OAuth 2.0 客户端 ID"，选择"Web 应用"类型
                      </p>
                      <Alert className="mt-3 bg-blue-50 border-blue-300">
                        <HelpCircle className="h-4 w-4 text-blue-600" />
                        <AlertDescription className="text-blue-800 text-sm">
                          <strong>重要提示：</strong>记住当前 GCP Project 的项目编号（Project
                          Number），后续申请 Developer Token 时必须在同一个 Project
                          中进行，即注册MCC和GCP的Gmail邮箱需要保持同一个。
                        </AlertDescription>
                      </Alert>
                    </div>
                  </div>
                      ...
                      <div className="text-sm text-gray-600 mt-1 space-y-2">
                        <p>
                          ...
                          <code className="bg-gray-100 px-2 py-0.5 rounded text-xs">
                            https://www.autoads.dev/api/google-ads/oauth/callback
                          </code>
                        </p>
                        <p>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="text-sm text-gray-600 mt-1 space-y-2">
                        <p>
                          创建完成后，点击客户端名称查看 <strong>客户端 ID</strong>和
                          <strong>客户端密钥</strong>
                        </p>
                        <div className="p-3 bg-gray-50 border rounded-lg">
                          ...
                          <p className="mt-2 text-xs text-gray-600">
                            其中开头的数字{' '}
                            <code className="bg-white px-1 rounded border">123456789012</code> 就是
                            GCP Project Number
                          </p>
                        </div>
                      </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      <h4 className="font-medium" id="oauth-developer-token">
                        申请 Developer Token
                      </h4>
                      <p className="text-sm text-gray-600 mt-1">
                        访问{' '}
                        ...
                        申请 Token，OAuth 方式需要 <strong>基本访问权限</strong>（审核1-3个工作日）
                      </p>
                      ...
                      <Alert className="mt-3 bg-red-50 border-red-300" id="project-matching">
                        ...
                        <AlertDescription className="text-red-800">
                          <div className="font-semibold mb-2">
                            关键要求：Developer Token 必须与 OAuth Client ID 来自同一个 GCP Project
                          </div>
                          <ul className="text-sm space-y-1 ml-4 list-disc">
                            <li>
                              在申请 Developer Token 时，确保选择的 GCP Project 与步骤3创建 OAuth
                              Client 的 Project 相同
                            </li>
                            <li>
                              Client ID 格式为{' '}
                              <code className="bg-red-100 px-1 rounded">
                                项目编号-xxx.apps.googleusercontent.com
                              </code>
                              ，其中"项目编号"就是 Project Number
                            </li>
                            <li>
                              如果配置不匹配，API 调用会报错：
                              <code className="bg-red-100 px-1 rounded">
                            ...
                            <li>
                              <strong>解决方法</strong>：要么在 Client ID 所属的 Project 重新申请
                              Developer Token，要么在 Developer Token 所属的 Project 重新创建 OAuth
                              Client
                            </li>
                          </ul>
                        </AlertDescription>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600 mt-1">
                        在系统设置页面配置 Client ID、Client Secret、Developer Token，然后点击"启动
                        OAuth 授权"
                      </p>
                    </div>
                  </div>
                ...
                <Alert className="mt-4 bg-blue-50 border-blue-200">
                  ...
                  <AlertDescription>
                    <strong>提示：</strong>OAuth 方式正式使用需要"基本访问权限"或更高级别的
                    Developer Token。建议先使用测试权限进行配置验证，同时向 Google
                    申请更高权限（审核 1-3 个工作日）。权限升级后自动生效，无需重新配置。
                  </AlertDescription>
                </Alert>
              </CardContent>
            </Card>
          ...
          <TabsContent value="service-account" className="space-y-4 mt-4">
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600 mt-1">
                        ...
                        中创建项目，然后在"API和服务"→"库"中启用 <strong>Google Ads API</strong>
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600 mt-1">
                        在 Google Ads MCC 的"访问权限和安全"中添加服务账号邮箱，分配
                        <strong>标准角色</strong>
                      </p>
                    </div>
                  </div>
                ...
                <Alert className="mt-4 bg-blue-50 border-blue-200">
                  <AlertDescription>
                    <strong>提示：</strong>初次申请会获得测试权限的 Developer
                    Token，仅能访问测试账号。如需访问真实账号，需要申请 Basic Access
                    或更高级别，或使用 OAuth 授权方式。
                  </AlertDescription>
                </Alert>
                ...
                <Alert className="mt-4 bg-amber-50 border-amber-200">
                  ...
                  <AlertDescription>
                    <strong>功能限制：</strong>服务账号模式无法使用 Keyword Planner API（需要 Basic
                    Access
                ...
                <div className="text-sm space-y-3">
                    ...
                    <div className="bg-white rounded-lg p-3 border border-gray-200">
                      ...
                      <ul className="text-sm text-gray-600 space-y-1 ml-2">
                        <li className="flex items-start gap-2">
                          ...
                          <span>
                            <strong>仅限测试账号</strong>：无法访问真实的 Google Ads 账号
                          </span>
                        </li>
                        <li className="flex items-start gap-2">
                  ...
                  <Alert className="bg-green-50 border-green-200">
                    ...
                    <AlertDescription className="text-sm">
                      <strong>推荐策略：</strong>如需访问真实账号，建议直接申请 Basic/Standard
                      Access 或使用 OAuth 授权方式，避免测试权限的限制。
                    </AlertDescription>
                  </Alert>
                  ...
                  <div className="bg-gray-50 rounded-lg p-3 text-xs text-gray-600">
                    ...
                    <p>
                      ...
                      ，查看 Developer Token 状态。如显示"Test - Ready to
                      use"表示测试权限，升级后会显示为其他级别。
                    </p>
                  </div>
                </div>
              </CardContent>
            ...
            <Card id="service-account-json">
              ...
              <CardContent className="text-sm space-y-3">
                <ol className="list-decimal list-inside space-y-3">
                  ...
                  <li>点击"创建服务账号"，填写名称和描述后点击"创建"</li>
                  <li>
                    在<strong>"授予此服务账号的权限"</strong>步骤中：
                    <ul className="list-disc list-inside ml-4 mt-1 text-gray-600">
                      <li>展开"基本"角色列表</li>
                      <li>
                        选择<strong>"所有者"</strong>（Owner）或根据需求选择自定义权限
                      </li>
                    </ul>
                  </li>
                  <li>点击"创建密钥"，选择"JSON"类型，点击"创建"下载文件</li>
                  <li>用文本编辑器打开下载的文件，复制完整内容</li>
                </ol>
                <Alert className="mt-3 bg-amber-50 border-amber-200">
                  <AlertCircle className="h-4 w-4 text-amber-500" />
                  <AlertDescription>
                    <strong>重要：</strong>服务账号邮箱必须添加到 Google Ads MCC
                    的"访问权限和安全"中，否则无法访问 API
                  </AlertDescription>
                </Alert>
              </CardContent>
            </Card>
              ...
              <CardContent className="space-y-4">
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    <strong>推荐使用 OAuth 方式</strong>。无论是管理自己的账号还是 MCC 账号，OAuth
                    都能提供更稳定的功能支持（包括 Keyword Planner
                    API）。服务账号方式将在未来版本中逐步下线。
                  </p>
                </div>
                <div>
                  <h4 className="font-semibold mb-2">Q: Developer Token 审核需要多久？</h4>
                  <p className="text-sm text-gray-600">
                    <strong>测试权限</strong>（Test Access）立即可用，但仅能访问测试账号；
                    <strong>Basic/Standard Access</strong> 需要申请审核（1-3
                    个工作日），可访问真实账号。
                  </p>
                </div>
                <div>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="bg-white rounded-lg p-4 border border-orange-200">
                  <h5 className="font-semibold text-orange-800 mb-3 flex items-center gap-2">
                    <span className="w-5 h-5 bg-orange-100 rounded flex items-center justify-center text-xs">
                      !
                    </span>
                    错误：服务账号配置不完整
                  </h5>
                  ...
                  <div className="space-y-3 ml-2">
                    <div className="flex items-start gap-2">
                      <span className="w-6 h-6 bg-orange-100 rounded-full flex items-center justify-center text-xs shrink-0">
                        1
                      </span>
                      <div>
                ...
                <div className="bg-white rounded-lg p-4 border-2 border-yellow-300">
                  ...
                  <p className="text-sm text-gray-600 mb-3">
                    ...
                    错误，说明您的 Developer Token 还是 <strong>Test Account Access</strong>{' '}
                    级别，只能访问测试账号。
                  </p>
                  ...
                  <div className="space-y-3 ml-2">
                    <div className="flex items-start gap-2">
                      <span className="w-6 h-6 bg-green-100 rounded-full flex items-center justify-center text-xs shrink-0 font-bold">
                        推荐
                      </span>
                      <div>
                        <strong className="text-sm text-green-700">
                          申请 Basic/Standard Access
                        </strong>
                        <p className="text-xs text-gray-600 mt-1">
                          访问{' '}
                          <a
                          ...
                          ，点击"Apply for Basic Access"或"Apply for Standard Access"。审核通常需要
                          1-3 个工作日。
                        </p>
                    ...
                    <div className="flex items-start gap-2">
                      <span className="w-6 h-6 bg-purple-100 rounded-full flex items-center justify-center text-xs shrink-0">
                        2
                      </span>
                      <div>
                        ...
                        <p className="text-xs text-gray-600 mt-1">
                          创建{' '}
                          <a
                            href="https://developers.google.com/google-ads/api/docs/best-practices/test-accounts"
                            target="_blank"
                            className="text-blue-600 hover:underline"
                          >
                            Test Manager Account
                          </a>
                          ，Test Account Access Token 可以立即使用（但只能测试，无法投放真实广告）。
                        </p>
                      </div>
                    </div>
                  </div>
                    ...
                    <AlertDescription className="text-sm">
                      ...
                      <a
                        ...
                        onClick={(e) => {
                          e.preventDefault()
                          document
                            .querySelector('.border-blue-200.bg-blue-50\\/30')
                ...
                <div className="bg-white rounded-lg p-4 border border-red-200">
                  <h5 className="font-semibold text-red-800 mb-3 flex items-center gap-2">
                    <span className="w-5 h-5 bg-red-100 rounded flex items-center justify-center text-xs">
                      !
                    </span>
                  ...
                  <p className="text-sm text-gray-600 mb-3">
                    ...
                    错误，说明服务账号没有被添加到 Google Ads MCC 账户中。
                  </p>
                  <p className="text-sm text-gray-600 mb-2">
                    <strong>解决方法：</strong>
                  </p>
                  <ol className="text-sm text-gray-600 list-decimal list-inside space-y-2 ml-1">
                    ...
                    <li>
                      ...
                      <ul className="list-disc list-inside ml-4 mt-1 text-gray-600">
                        <li>
                          点击 <strong>"Tools & Settings" → "Access and security"</strong>
                        </li>
                        <li>
                          点击 <strong>"Add Access"</strong> 或 <strong>"Link Account"</strong>
                        </li>
                        <li>
                          输入服务账号邮箱（如{' '}
                        ...
                        <li>
                          分配角色：<strong>"Admin access"</strong> 或{' '}
                  ...
                  <Alert className="mt-3 bg-amber-50 border-amber-200">
                    <AlertCircle className="h-4 w-4 text-amber-500" />
                    <AlertDescription className="text-sm">
                      <strong>重要：</strong>服务账号必须被添加到 Google Ads MCC 账户中，即使它在
                      Google Cloud 有完全权限。
                    </AlertDescription>
                  </Alert>
                </div>
        ...
        <Card className="mt-6">
          ...
          <CardContent>
            <div className="grid md:grid-cols-2 gap-4">
              ...
              <a
                href="https://developers.google.com/google-ads/api/docs/oauth/service-accounts"
                target="_blank"
                className="flex items-center gap-2 p-3 rounded-lg hover:bg-gray-50 transition-colors"
              >
                <ExternalLink className="w-4 h-4 text-blue-500" />
