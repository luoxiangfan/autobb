...
const CreativesAnalyticsSection = dynamic(() => import('./CreativesAnalyticsSection'), {
  ssr: false,
  loading: () => <CreativesAnalyticsSectionSkeleton />,
})
...
function CreativesAnalyticsSectionSkeleton() {
  return (
    <div className="mb-6">
      <div className="mb-4 h-8 w-44 rounded bg-gray-100" />
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
        ...
        {analyticsSectionMounted ? (
          ...
          <CreativesAnalyticsSectionSkeleton />
        )}
