...
export default function TaskDetailPage() {
  ...
  const distributionData = {
    ...
    hourlyActual,
    hourlyConfigured: Array.isArray(task.hourly_distribution)
      ...
      <main className="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8 space-y-6">
        ...
        <Card>
          <CardHeader className="pb-3">
            <CardTitle className="text-sm font-medium text-gray-600">关联 Offer</CardTitle>
          </CardHeader>
            ...
            <CardContent className="pt-0">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-xs text-muted-foreground mt-1">基于点击数推算</p>
                </div>
        ...
        <Card>
          <CardHeader className="pb-3">
            <CardTitle className="text-sm font-medium text-gray-600">任务配置</CardTitle>
          </CardHeader>
          <CardContent>
